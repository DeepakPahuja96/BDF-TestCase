...
WS.verifyElementPropertyValue(response, 'message', 'The entered username/email is already exists in our database, it may be associated with a user in different organization.')
